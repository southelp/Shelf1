        ...
        <div className="mt-6">
          ...
          <ul className="space-y-3">
            {candidates.map((c, idx) => (
              ...
              >
                <img src={c.cover_url || 'https://via.placeholder.com/80x120.png?text=No+Image'} alt={c.title} className="object-contain rounded bg-gray-100 flex-shrink-0" style={{ height: '120px', width: 'auto' }} />
